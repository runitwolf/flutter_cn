class Api {
  // baseUrl
  static final BASE_URL = "https://www.wanandroid.com/";
...
//  体系
  static final String HOME_Tree = 'tree/json';

// 体系下的文章
  static final String HOME_SYSTEM_CHILD = 'article/list/';

  // 公众号
  static final String WX_URL = 'wxarticle/chapters/json';

  //公众号页面的内容
  static final String WX_FRAGMENT_URL = 'wxarticle/list/';

  //公众号页面的内容
  static final String COLLECT_URL = 'lg/collect/list/';
}
